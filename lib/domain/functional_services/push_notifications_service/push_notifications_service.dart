import 'package:base_project_template/data/res/const.dart';
...
import 'package:base_project_template/domain/functional_services/push_notifications_service/shared/message_adapter.dart';
...
class PushNotificationsService {
  ...
  void init() async {
    try {
      ...
      print('$tag -> <initialiseFCM> -> SUCCESS');
    } catch (e) {
  ...
  void _handleCurrentMessage(Message message) {
    if ((message.title != null && message.title != EMPTY_STRING) || (message.content != null && message.content != EMPTY_STRING)) {
      DialogService.instance.show(DefaultLoaderDialog(state: true, loaderKey: LoaderKey.global));
    }
  }
