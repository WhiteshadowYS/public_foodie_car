...
part 'get_data_request_colors_dto.g.dart';
...
class GetDataRequestColorsDto implements IDto {
  ...
  factory GetDataRequestColorsDto.fromJson(json) => _$GetDataRequestColorsDtoFromJson(json);

  Map<String, dynamic> toJson() => _$GetDataRequestColorsDtoToJson(this);
}
