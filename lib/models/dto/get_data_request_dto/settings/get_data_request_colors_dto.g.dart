...
part of 'get_data_request_colors_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetDataRequestColorsDto _$GetDataRequestColorsDtoFromJson(
    Map<String, dynamic> json) {
  return $checkedNew('GetDataRequestColorsDto', json, () {
    final val = GetDataRequestColorsDto(
...
Map<String, dynamic> _$GetDataRequestColorsDtoToJson(
        GetDataRequestColorsDto instance) =>
    <String, dynamic>{
      'font': instance.font,
